...
class GWPreviewConfirmation {
    ...
    public static function replace_merge_tags( $form ) {
        ...
        foreach($form['fields'] as &$field) {
            ...
            $field['content'] = str_replace('font-size:14px;', '', $field['content']);
            $field['content'] = str_replace('font-size:12px;', '', $field['content']);
            $field['content'] = str_replace('font-size:11px;', '', $field['content']);
            $field['content'] = str_replace('font-family: sans-serif;', '', $field['content']);
