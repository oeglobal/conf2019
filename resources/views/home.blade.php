...
@section('content')
  ...
  <h2 class="heading w-2/3 md:w-1/3">About</h2>
  <div class="flex flex-wrap -mx-4 overflow-hidden mb-20 md:mb-26">
    ...
    <div class="my-2 px-4 md:w-7/12 overflow-hidden">
      <p class="mb-6 sm-only:text-sm">The Open Education Global Conference is where the world meets to discuss how opening education helps us achieve
  ...
  <h2 class="heading w-2/3 md:w-1/3">The Venue</h2>
